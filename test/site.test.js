...
test('homepage is only the hero, example catalogue, compact FAQ, and footer', () => {
  ...
  is(document.querySelector('.site-footer .footer-name').textContent, 'web-audio-api', 'footer reinforces the package name')
  is(document.querySelector('.site-footer .footer-install').textContent, 'npm install web-audio-api', 'footer repeats the install command')
