...
test('homepage is only the hero, example catalogue, compact FAQ, and footer', () => {
  ...
  is(document.querySelector('.hero-lede').textContent.trim(), 'Your web-audio code, cross-platform. No native bindings, no compilation. Process audio in batch, unit-test it in CI, stream from servers, render at the edge, script it in CLI. Any JS engine:')
