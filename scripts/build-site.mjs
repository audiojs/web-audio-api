...
${example.seo ? `    <p class="detail-seo">${escapeHTML(example.seo)}</p>\n` : ''}  </main>
  ...
  <footer class="site-footer"><p><a class="footer-brand" href="https://audiojs.dev/"><svg viewBox="0 0 80 90" aria-hidden="true"><g fill="currentColor" stroke="currentColor"><path d="M28.6572 0L45 45H0L15.8672 0H28.6572Z"/><path d="M51.3428 89.9999L35 44.9999H80L64.1328 89.9999H51.3428Z"/></g></svg>AudioJS</a><span class="footer-facts"><span>208 KB</span><span>TypeScript</span><span>MIT</span><span>v${pkg.version}</span><span>since 2013</span></span><span class="footer-actions"><a href="https://github.com/sponsors/audiojs">Support development</a><a class="wpt-badge" href="https://github.com/audiojs/web-audio-api/actions/workflows/wpt.yml" aria-label="Web Platform Tests status"><img src="https://github.com/audiojs/web-audio-api/actions/workflows/wpt.yml/badge.svg" alt="W3C WPT status"></a></span></p></footer>
