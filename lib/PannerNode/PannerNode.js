...
class PannerNode extends AudioNode {
  ...
  constructor(context) {
    ...
    /** @type {PannerProvider} */
    this.pannerProvider = new PannerProvider()
    ...
    Object.defineProperty(this, 'maxDistance', {
      get() { return this._distanceModel._maxDistance },
      set(val) { return this._distanceModel.maxDistance = val },
    })
  ...
  _tick() {
    ...
    if (!this._inputs[0].isConnected() || !this._pannerModel) {
      outBuff.zero()
      return outBuff
    }
    ...
    this._panner.pan(azimuth, elevation, inBuff, outBuff, BLOCK_SIZE)
