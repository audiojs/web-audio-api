...
_.extend(AudioInput.prototype, {
  ...
  tick: function(outBuffer) {
    var computedNumberOfChannels = this.computedNumberOfChannels
    ...
    this.sources.forEach(function(source) {
      var inBuffer = source.buffer

      // Down-mixing the source
      if (source.computedNumberOfChannels > computedNumberOfChannels) {
