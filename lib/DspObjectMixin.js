...
module.exports = {
  ...
  _schedule: function(type, time, func, args, target) {
  	var event = {time: time, func: func, type: type}
  ...
  _unscheduleTypes: function(types) {
    this._scheduled = _.reject(this._scheduled, function(event) { return _.contains(types, event.type) })
  }
